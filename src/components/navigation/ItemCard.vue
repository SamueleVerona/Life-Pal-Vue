<template>
  <section class="item-card">
    <section class="card-box">
      ...
      <section class="card-info-box" v-if="!props.isRequest">
        <span class="item-meta item-meta--label"
          >Goal for a {{ props.goalType }}</span
        >
        <span class="item-meta item-meta--status">Set a completion for :</span>
        <span class="item-meta item-meta--time-slot">{{
          props.itemLabel
        }}</span>
      </section>
      <section class="card-controls" @mousedown="handleSubmit">
        <button
          type="button"
